...
module.exports = class extends Generator {
  ...
  generateSSLCerts () {
    ...
    const privatePem =  pems.private
    
    this.fs.write(this.destinationPath('./'+ this.packageName +'/certs/certPem.pem'), certPem)
    this.fs.write(this.destinationPath('./'+ this.packageName +'/certs/privatePem.pem'), privatePem)
  ...
  setParams () {
    ...
    if (this.enableHTTPS) {
      ...
      httpsParams.authInfoPath.authCertAndKey = {
        cert: './certs/certPem.pem',
        key: './certs/privatePem.pem'
      }
